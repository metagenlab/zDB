...
urlpatterns = [
    ...
    re_path(r'^amr_gene_comparison', views.AmrGeneComparisonView.as_view(),
            name="amr_gene_comparison"),
    re_path(r'^amr_class_comparison', views.AmrClassComparisonView.as_view(),
            name="amr_class_comparison"),
    re_path(r'^amr_subclass_comparison', views.AmrSubclassComparisonView.as_view(),
            name="amr_subclass_comparison"),
