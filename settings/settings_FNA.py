...
BIODB = "db_wise_curie" # '2019_06_PVC' #'chlamydia_04_16' #'2017_06_29b_motile_chlamydiae'
BIODB_DB_PATH = "/scratch/hdd2/acarrara/ChlamDB_pipeline/Comparative_db/annotation_pipeline_3_genomes_FNA/db/" + BIODB  + ".db"

BLAST_PATH= "/scratch/hdd2/acarrara/ChlamDB_pipeline/Comparative_db/annotation_pipeline_3_genomes_FNA/blast_DB/" #makeblastdb output split in /fna and /faa
...
DATABASES = {
    'default': {
        ...
        'NAME': "/scratch/hdd2/acarrara/ChlamDB_pipeline/Comparative_db/annotation_pipeline_3_genomes_FNA/db/db_wise_curie" #os.path.join(BASE_DIR, 'db.sqlite3'),
    }
}
