...
def import_16S_identity(identity_table, biodb):
    ...
    sql = 'create table IF NOT EXISTS custom_tables.identity_16S_%s (taxon_1 INT, ' \
          ' taxon_2 INT,' \
            ...
            if n == 0:
                ...
                for n, identity in enumerate(data[1:]):
                    ...
                    if [accession2taxon_id[accession_1],accession2taxon_id[accession_2]] not in pair_ok:
                        ...
                        sql = 'insert into  custom_tables.identity_16S_%s values (%s, %s, %s);' % (biodb,
...
if __name__ == '__main__':
    ...
    import_16S_identity(args.identity_table, args.db_name)
